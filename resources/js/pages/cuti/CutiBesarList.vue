...
function openCreate() { form.value = { tanggal_mulai: '', tanggal_selesai: '', jumlah_hari: 30, alasan: '' }; showForm.value = true; }
...
<template>
    <MobileListPegawai
        ...
        title="Cuti Besar"
        section-title="Riwayat Cuti Besar"
        :items="rows"
        :loading="loading"
        :can-add="canCreate"
        :item-title="() => 'Cuti Besar'"
